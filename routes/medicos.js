...
router.get('/agregar', (req, res) =>{
    res.status(200).sendFile('form-medicos.html', {root:'public'})
  })
...
router.get('/eliminar/:cedula', (req, res) => {
    ...
    router.post('/actualizar/:cedula', (req, res) => {
      ...
      const consultorio = req.body.consultorio
      const correo = req.body.correo
      conexion.query(`UPDATE medicos SET nombres='${nombres}', apellidos='${apellidos}', consultorio=${consultorio}, correo='${correo}' WHERE cedula=${cedula}`, (error, resultado) => {
        if (error) {
